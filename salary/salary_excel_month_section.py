from salary import salary_excel_sql_month_section
...
def mz_data(
    ...
    # sql_data
    sql_data_cnt = 0
    sql_data = salary_excel_sql_month_section.mz_sql_salary_store(salary_date_int)
    sql_data_cnt = len(sql_data)

    for dt in sql_data:

        # section_name
        section_name = salary_excel_sql_month_section.mz_sql_section_name(dt["staff_section_cd"])
