from salary import salary_excel_sql_nendo_staff
...
def mz_data(
    ...
    # sql_data
    sql_data_cnt = 0
    sql_data = salary_excel_sql_nendo_staff.mz_sql_salary_store(salary_date_int, nendo)
    ...
    for dt in sql_data:
        ...
        salary_kind_name = salary_excel_sql_nendo_staff.mz_sql_salary_kind_name(dt["salary_kind_cd"])
