...
# data 当月 契約件数のみ
def mz_data_tou_kensu(keijyo_date_int, keiyaku_grp_cd, cat_cd, section_cd, staff_email):
    sql1 = """
        SELECT
        ss.cnt AS cnt,
...
# data 累計 契約件数のみ
def mz_data_rui_kensu(keijyo_nendo, keiyaku_grp_cd, cat_cd, section_cd, staff_email):
    sql1 = """
        SELECT
        ss.cnt AS cnt,
        coltd.cat_cd AS cat_cd,
