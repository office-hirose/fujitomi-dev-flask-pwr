...
# data 当月
def mz_data_tou(keijyo_date_int, keiyaku_grp_cd, cat_cd, section_cd, staff_email):
    sql1 = """
        SELECT
        ss.cnt AS cnt,
...
# data 累計
def mz_data_rui(keijyo_nendo, keijyo_date_int, keiyaku_grp_cd, cat_cd, section_cd, staff_email):
    sql1 = """
        SELECT
        ss.cnt AS cnt,
        coltd.cat_cd AS cat_cd,
