...
def set_sheet(sheet_dic):
    ...
    # 代理店手数料／1.1＝手数料税抜
    # 初年度次年度=不明：0をセット
    # 証券番号の1件目、セルF2＝'furikae-system-fee'

    syoken = 37  # col AK 証券番号
    fee_withtax = 44  # col AR 代理店手数料
    kaime = 50  # col AX 回目
    ...
    # 証券番号、F2に'furikae-system-fee'をセット、kind_cd 2をセット
    new_sheet.update_cell(2, 6, "furikae-system-fee")
    new_sheet.update_cell(2, 5, 2)
